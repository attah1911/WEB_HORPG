...
<body>
    ...
    <div class="mainpage">
        <div class="content_berita">
            ...
            $sql = mysqli_query($conn, "SELECT * FROM berita WHERE Terbit = '1' ORDER
                ...
                while ($r = mysqli_fetch_array($pop)) {
                    ...
                    <div class="card-berita-kecil">
                        ...
                        <div class="info-berita-kecil>
                            <span class="view-berita" style="color: #333; margin-left: 5px;">
                                ' . substr($Tanggal, 0, 10) . ' | View: <b>' . $View . '</b>
                            </span>
                            <div class="card-text-kecil">
                                <h1><a href="login.php">' . $Judul . '</a></h1>
                            </div>
                        </div>
                    </div>
                    ';
